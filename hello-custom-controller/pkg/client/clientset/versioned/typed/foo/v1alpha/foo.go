...
import (
	...
	scheme "github.com/takaishi/hello2019/hello-custom-controller/pkg/client/clientset/versioned/scheme"
...
type FooInterface interface {
	Create(*v1alpha.Foo) (*v1alpha.Foo, error)
	Update(*v1alpha.Foo) (*v1alpha.Foo, error)
	UpdateStatus(*v1alpha.Foo) (*v1alpha.Foo, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha.Foo, error)
	List(opts v1.ListOptions) (*v1alpha.FooList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha.Foo, err error)
	FooExpansion
}
...
func newFoos(c *SamplecontrollerV1alphaClient, namespace string) *foos {
	return &foos{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *foos) Get(name string, options v1.GetOptions) (result *v1alpha.Foo, err error) {
	result = &v1alpha.Foo{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) List(opts v1.ListOptions) (result *v1alpha.FooList, err error) {
	result = &v1alpha.FooList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) Create(foo *v1alpha.Foo) (result *v1alpha.Foo, err error) {
	result = &v1alpha.Foo{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) Update(foo *v1alpha.Foo) (result *v1alpha.Foo, err error) {
	result = &v1alpha.Foo{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) UpdateStatus(foo *v1alpha.Foo) (result *v1alpha.Foo, err error) {
	result = &v1alpha.Foo{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha.Foo, err error) {
	result = &v1alpha.Foo{}
